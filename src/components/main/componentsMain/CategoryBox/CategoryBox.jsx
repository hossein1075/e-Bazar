...
function CategoryBox({img, title, name}) {
  return (
    <>
      <div className='relative overflow-hidden border-t-3 border-solid border-orange-600 rounded-b-3xl shadow-sub  py-3 sm:p-0 text-center sm:text-left bg-white sm:bg-transparent'>
        <img src={img} className='hidden sm:block w-full  transition-all duration-500 ease-linear hover:scale-110' alt="category" />
        <div className='sm:absolute sm:top-1/2 sm:left-[3%] sm:-translate-y-1/2'>
          <h2 className='mb-2 font-bold font-Lato-Bold tracking-tightest text-orange-600'>
          ...
          <h4 className='text-3xl md:text-4xl tracking-tightest2 mb-4 md:mb-8'>{name}</h4>
