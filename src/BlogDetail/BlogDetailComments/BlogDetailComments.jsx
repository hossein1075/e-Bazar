...
function BlogDetailComments() {
    return (
        <>
            <section className='mt-6 sx:mt-0'>
                <div className="container">
                    <div className='bg-white mb-4 p-4 rounded-2xl'>
                        <div className='mb-3 md:mb-4 leading-[150%] tracking-tightest4'>
                            <span>24 Aug, 2024</span>
                            <span>/</span>
                            <span> 02 Comments</span>
                        </div>
                        <div>
                            <h4 className='mb-3 md:mb-4 font-Lato-Bold font-bold text-zinc-900 text-2xl sx:text-lg'>Fun and Safe Outdoor Toys for Active Kids: Keep Them Engaged and Healthy</h4>
                            <p className='mb-6'>
                            ...
                            <div className='p-4 mb-3 md:mb-6 bg-[url(/images/BlogDetail/blog-bg.png)] bg-center bg-no-repeat bg-cover rounded-10px'>
                                <div className='mb-6 text-3xl hidden sx:block'>
                                    <span>
                                        <ImQuotesRight  className='text-white/50' size={45}/>
                                    </span>
                                </div>
                                <p className='text-zinc-50 mb-3 md:mb-6'>
                                ...
                                <h5 className='text-zinc-50 mb-3 md:mb-6'>Emma Grace</h5>
                            </div>
                        </div>
                        <h6 className='mb-3 md:mb-5 font-Lato-Bold font-bold'>1. Ride-On Toys</h6>
                        <p className='leading-[150%] tracking-tightest4 mb-3 md:mb-6'>Outdoor play is crucial for a child's overall development. It helps improve physical strength,
                        ...
                        <div className='flex flex-col md:flex-row gap-6 justify-center mb-3 md:mb-6'>
                        ...
                        <h6 className='mb-3 md:mb-5 font-Lato-Bold font-bold'>2. A Complex Genius</h6>
                        <p className='leading-[150%] tracking-tightest4 mb-3 md:mb-6'>Outdoor play is crucial for a child's overall development. It helps improve physical strength,
                            coordination, and balance while also promoting mental well-being.
                            Kids who play outside regularly are more likely to develop strong social skills and a love for nature. Additionally,
                            outdoor play reduces screen time, helping to improve sleep patterns and reduce the risk of obesity.
